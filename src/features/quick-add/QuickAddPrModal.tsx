...
import { savePullRequest } from '../../services/firestorePullRequests'
import { useRefreshStore } from '../../stores/refresh'
import { useToastStore } from '../../stores/toast'
import type { PrStatus } from '../../types/pullRequest'
    ...
    <dialog ref={dialogRef} className={styles.dialog}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        <div className={styles.field}>
          ...
          <input id="qa-pr-nummer" className={styles.input} value={nummer} onChange={e => setNummer(e.target.value)} />
          {nummerError && <span className={styles.error}>{nummerError}</span>}
        </div>
        <div className={styles.field}>
          <label className={styles.label} htmlFor="qa-pr-titel">Titel *</label>
          <input id="qa-pr-titel" className={styles.input} value={titel} onChange={e => setTitel(e.target.value)} />
        ...
        <div className={styles.field}>
          ...
          <input id="qa-pr-reviewer" className={styles.input} value={reviewer} onChange={e => setReviewer(e.target.value)} />
        </div>
        <div className={styles.field}>
